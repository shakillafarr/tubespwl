			...
			<div class="row about_row">
				...
				<div class="col-lg-4 about_col about_col_left">
					<div class="about_item">
						<div class="about_item_image"><img src="<?=base_url()?>asset/images/about_1.jpg" alt=""></div>
				...
				<div class="col-lg-4 about_col about_col_middle">
					<div class="about_item">
						<div class="about_item_image"><img src="<?=base_url()?>asset/images/about_2.jpg" alt=""></div>
				...
				<div class="col-lg-4 about_col about_col_right">
					<div class="about_item">
						<div class="about_item_image"><img src="<?=base_url()?>asset/images/about_3.jpg" alt=""></div>
